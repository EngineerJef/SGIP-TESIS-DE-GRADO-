        ...
        <div id="wrapper">
            ...
            <form class="formulario_1" id="formulario_gestion"> 
               ...
               <div class="card-box"> 
                ...
                <input type="hidden" name="accion" value="inmueble">
                                                     
                            <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0">Panel de opciones</h4>
                                    
                                    <button type="button" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5" id="registrar_inmueble">Guardar</button>
