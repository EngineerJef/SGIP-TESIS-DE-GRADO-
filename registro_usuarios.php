...
<html lang="es">
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <form class="formulario_2" id="formulario_registro"> 
               ...
               <div class="card-box"> 
                ...
                <input type="hidden" name="accion" value="usuario">
                            ...
                            <div class="card-box">
                                    ...
                                    <button type="button" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5" id="registrar_usuario">Guardar</button>
...
<script type="text/javascript">
    ...
    $('#cedula').keyup(function(){
      $("#registrar_usuario").trigger('reset')
      ...
      if(num!=""){
                         $.ajax({
                          url:"include/funciones.php",
                          data:{accion:"cons_registro", cedula:num},
                          method:"POST",
                          success:function(result){
                                                                    console.log(result);
                             ...
                             if(result!="error"){
                                        ...
                                        console.log(json);
                                          ...
                                          $('input[name="nombres"]').attr("value",value.nombres);
                                          $('input[name="apellidos"]').attr("value",value.apellidos);
                                          $('input[name="telefono"]').attr("value",value.telefono);
                                          $('input[name="contrasena"]').attr("value",value.contrasena);
                                          $('select[name="tipo_usuario"] option[value="'+ value.tipo_usuario +'"]').attr("selected",true);
